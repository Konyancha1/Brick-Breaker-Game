...
class Brick(GameObject):
    COLORS = {1: 'dark violet', 2: 'purple', 3: 'indigo', 4: '#330066', 5: '#32127a'}
...
class Breakout_Game(tk.Frame):
    def __init__(self, master):
        ...
        for x in range(5, self.width - 5, 75):
            ...
            self.add_brick(x + 37.5, 200, 1)
            self.add_brick(530 + 37.5, 200, 1)
            self.add_brick(x + 37.5, 220, 1)
            self.add_brick(530 + 37.5, 220, 1)
            self.add_brick(5 + 37.5, 240, 5)
            self.add_brick(305 + 37.5, 240, 5)
            self.add_brick(305 + 37.5, 260, 5)
            self.add_brick(305 + 37.5, 280, 5)
            self.add_brick(230 + 37.5, 240, 5)
            self.add_brick(230 + 37.5, 260, 5)
            self.add_brick(230 + 37.5, 280, 5)
            self.add_brick(530 + 37.5, 240, 5)
            self.add_brick(5 + 37.5, 260, 5)
            self.add_brick(530 + 37.5, 260, 5)
            self.add_brick(5 + 37.5, 280, 5)
            self.add_brick(530 + 37.5, 280, 5)
            self.add_brick(x + 37.5, 300, 1)
            self.add_brick(x + 37.5, 320, 2)
            self.add_brick(x + 37.5, 340, 3)
            self.add_brick(x + 37.5, 360, 4)
            self.add_brick(x + 37.5, 380, 5)
