...
from pygame import mixer  # import from pygame library
...
class Brick(GameObject):
    COLORS = {1: 'dark violet', 2: 'purple', 3: 'indigo', 4: '#330066'}
...
class Breakout_Game(tk.Frame):
    def __init__(self, master):
        ...
        for x in range(5, self.width - 5, 75):
            ...
            self.add_brick(310 + 37.5, 220, 3)
            self.add_brick(235 + 37.5, 220, 3)
            self.add_brick(365 + 37.5, 240, 3)
            self.add_brick(415 + 37.5, 260, 3)
            self.add_brick(185 + 37.5, 240, 3)
            self.add_brick(135 + 37.5, 260, 3)
            self.add_brick(185 + 37.5, 280, 3)
            self.add_brick(365 + 37.5, 280, 3)
            self.add_brick(235 + 37.5, 300, 3)
            self.add_brick(310 + 37.5, 300, 3)
            self.add_brick(20 + 37.5, 320, 4)
            self.add_brick(20 + 37.5, 340, 4)
            self.add_brick(520 + 37.5, 320, 4)
            self.add_brick(520 + 37.5, 340, 4)
            self.add_brick(x + 37.5, 360, 4)
            self.add_brick(20 + 37.5, 200, 4)
            self.add_brick(20 + 37.5, 220, 4)
            self.add_brick(x + 37.5, 180, 4)
            self.add_brick(520 + 37.5, 200, 4)
            self.add_brick(520 + 37.5, 220, 4)
            self.add_brick(275 + 37.5, 260, 2)
            self.add_brick(275 + 37.5, 280, 2)
            self.add_brick(275 + 37.5, 240, 2)
            self.add_brick(x + 37.5, 160, 2)
            self.add_brick(x + 37.5, 380, 2)
